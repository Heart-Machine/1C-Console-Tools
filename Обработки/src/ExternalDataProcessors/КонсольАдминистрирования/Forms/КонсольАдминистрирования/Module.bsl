...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоБазаТРГ = ?(Метаданные.РегистрыСведений.Найти("сс_РегистрацияСтатусов") <> Неопределено, Истина, Ложь);
	Элементы.ГруппаТРГ.Видимость = ЭтоБазаТРГ;
	Элементы.Промежуток4.Видимость = ЭтоБазаТРГ;
