...
Процедура ЗаменитьПарольПользователя()
	...
	ПользовательИнформационнойБазы = ПользователиИнформационнойБазы.НайтиПоУникальномуИдентификатору(ПользовательИБ.ИдентификаторПользователяИБ);
	...
	ИмяДляВхода = ПользовательИнформационнойБазы.Имя;
